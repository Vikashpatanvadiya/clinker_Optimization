...
import { Menu, Settings, Zap, Building2 } from 'lucide-react';
          ...
          <div className="flex items-center space-x-2 sm:space-x-3">
            ...
            <div>
              <h1 className={`text-lg sm:text-xl font-bold ${
                ...
                <span className="hidden sm:inline">Clinker Optimization</span>
                <span className="sm:hidden">Clinker</span>
              </h1>
              <p className={`text-xs sm:text-sm ${
                isPremium ? 'text-premium-neon/70' : 'text-gray-500'
              }`}>
                <span className="hidden sm:inline">Supply Chain Dashboard</span>
